...
object Constants {
    ...
    // Step 2: Define the API key and query param of the URL as that we are going to use in the URL to get the response.
    // START
    const val BASE_URL = "https://api.spoonacular.com/"
    const val API_ENDPOINT:String = "recipes/random"

    // API KEY VALUE from the spoonacular console.
    const val API_KEY_VALUE: String = "ec4f4bc22f0c432880c14cfc5e63210e"
